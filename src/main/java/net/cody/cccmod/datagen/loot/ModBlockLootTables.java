package net.cody.cccmod.datagen.loot;
...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.ENDSTONE_SAPPHIRE_ORE.get(), block -> createCopperLikeOreDrops(ModBlocks.ENDSTONE_SAPPHIRE_ORE.get(), ModItems.RAW_SAPPHIRE.get()));
    }

package net.cody.cccmod.block;

import net.cody.cccmod.CCCMod;
import net.cody.cccmod.block.custom.SoundBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, CCCMod.MODID);

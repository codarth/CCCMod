...
import net.cody.cccmod.item.custom.FuelItem;
import net.cody.cccmod.item.custom.MetalDetectorItem;
...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, CCCMod.MODID);
